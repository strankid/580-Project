...
#change these params
    d = dim #128                       # dimension
    nb = data_size #1000000000                   # database size, 1B
    nq = nqueries #10000                       # nb of queries
    np.random.seed(1234)             # make reproducible
    gpu = False

    test_datapath = test_path    #"../data/sift-1b/queries.npy"
    nns_datapath =  nns_path     #"../data/sift-1b/neighbors100.npy"
    ...
    index_path = Index_path #"sift1b_ivf16384_PQ96.index"
    ...
    k = K #100                       # we want to see 4 nearest neighbors
